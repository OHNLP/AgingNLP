...
def load_data():
	df = pd.read_csv('/infodev1/phi-projects/dhs/workspace-sf/MCI/BERT_data/data/NLP_input/fl/training_rep.txt', delimiter= '\t', header=None, names=['docid', 'sentence', 'label'])
...
# 			'Training Time': training_time,
	...
	output_dir = './output_models/site_rep/bert_output/'	
...
# 	model.cuda()
    ...
    # Flower client
	class MCIClient2(fl.client.NumPyClient):
    ...
    # Start client
	fl.client.start_numpy_client(server_address="127.0.0.1:8080", client=MCIClient2())
