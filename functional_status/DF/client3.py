...
def load_data():
	...
	epochs_num = 3
	df = pd.read_csv('/data/sfu3/workspace/mci/data/training_rep.csv', delimiter= '\t', header=None, names=['docid', 'sentence', 'label'])
	df = df.dropna()
...
# 		"emilyalsentzer/Bio_ClinicalBERT",
	...
	class MCIClient3(fl.client.NumPyClient):
		...
		def evaluate(self, parameters, config):
			self.set_parameters(parameters)
			loss, accuracy = test(model, testloader, epochs=4)
